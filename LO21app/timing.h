...
namespace TIME {
	...
	*/	
	...
	public:
        ...
        QDate getQDate() const { return QDate(annee, mois, jour); } //! Retourne l'ann�e de la date
        ...
        bool operator<=(const Date& d) const; //! Compare deux dates dans le temps : d1<=d2 retourne true si d1 est avant ou bien �gale � d2
	...
	*/	
	...
	public:
        ...
        unsigned int getDureeEnHeuresInt() const { return nb_minutes/60; } //!Retourne la duree en heures tronqu�e � l'heure pr�s
